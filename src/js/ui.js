...
let UIController = (() => {
	...
	function drawTree(){
		...
		dTree.init(modelController.storage.getData(), {
			...
			callbacks: {	// Example of Callbacks usage - https://github.com/ErikGartner/dTree

			  nodeClick: function(name, extra) {

				  let target = $(d3.event.target);
				  let id = target.closest('foreignObject > div > div').attr('id'); 	//this.id;  ID from data object storage (modelController.storage.getData), not generated by dTree
